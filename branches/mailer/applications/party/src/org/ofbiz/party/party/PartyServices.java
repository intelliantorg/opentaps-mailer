...
public class PartyServices {
     ...
     */
    public static Map createPerson(DispatchContext ctx, Map context) throws GenericServiceException {
...
//        LocalDispatcher dispatcher = ctx.getDispatcher();
        ...
        if (party != null) {
            ...
            Map newPartyMap = null;
            
            if(resourceType!=null && resourceType.equals("Car")){
            	newPartyMap = UtilMisc.toMap("partyId", partyId, "partyTypeId", "RESOURCE", "description", description, "createdDate", now, "lastModifiedDate", now, "statusId", statusId);
            	
////            	if(resourceType!=null && resourceType.equals("Car")){
//    	            Map input = new HashMap<String,Object>();
//    				//input.put("userLogin", userLogin);
//    				input.put("partyId", partyId);
//    				input.put("roleTypeId", "CAR");
//    				dispatcher.runSync("createPartyRole", input);
////                }
            }else{
            	newPartyMap = UtilMisc.toMap("partyId", partyId, "partyTypeId", "PERSON", "description", description, "createdDate", now, "lastModifiedDate", now, "statusId", statusId);
            }
    ...
    public static Map createPartyDataSource(DispatchContext ctx, Map context) {
        ...
        try {
            ...
            GenericValue partyDataSource = delegator.makeValue("PartyDataSource", UtilMisc.toMap("partyId", partyId, "dataSourceId", dataSourceId, "fromDate", fromDate, "comments", comments));
