...
public class ShoppingCart implements Serializable {
    ...
    protected String firstAttemptOrderId = null;
    protected String externalId = null;
    protected String internalCode = null;
    protected String billingAccountId = null;
    protected double billingAccountAmt = 0.00;
    protected String agreementId = null;
    protected String quoteId = null;
    protected long nextItemSeq = 1;

    protected String defaultItemDeliveryDate = null;
    protected String defaultItemComment = null;

    protected String orderAdditionalEmails = null;
    protected boolean viewCartOnAdd = false;
    protected boolean readOnlyCart = false;

    protected Timestamp lastListRestore = null;
    protected String autoSaveListId = null;

    /** Holds value of order adjustments. */
    protected List adjustments = new LinkedList();
    // OrderTerms
    protected boolean orderTermSet = false;
    protected List orderTerms = new LinkedList();

    protected List cartLines = FastList.newInstance();
    protected Map itemGroupByNumberMap = FastMap.newInstance();
    protected long nextGroupNumber = 1;
    protected List paymentInfo = FastList.newInstance();
    protected List shipInfo = FastList.newInstance();
    protected Map contactMechIdsMap = new HashMap();
    protected Map orderAttributes = new HashMap();
    protected Map attributes = new HashMap(); // user defined attributes
    // Lists of internal/public notes: when the order is stored they are transformed into OrderHeaderNotes
    protected List internalOrderNotes = FastList.newInstance(); // internal notes
    protected List orderNotes = FastList.newInstance(); // public notes (printed on documents etc.)

    /** contains a list of partyId for each roleTypeId (key) */
    protected Map additionalPartyRole = new HashMap();

    /** these are defaults for all ship groups */
    protected Timestamp defaultShipAfterDate = null;
    protected Timestamp defaultShipBeforeDate = null;
    ...
    protected List productPromoUseInfoList = new LinkedList();
    /** Contains the promo codes entered */
    protected Set productPromoCodes = new HashSet();
    protected List freeShippingProductPromoActions = new ArrayList();
    ...
    protected Map desiredAlternateGiftByAction = new HashMap();
