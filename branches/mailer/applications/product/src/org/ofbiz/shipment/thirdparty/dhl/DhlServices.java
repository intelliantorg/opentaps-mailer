    ...
    public static Map dhlShipmentConfirm(DispatchContext dctx, Map context) {
        ...
        try {
            ...
            if ((billingWeight != null) && (billingWeight.doubleValue() > 0)) {
                ...
                // convert
                results = dispatcher.runSync("convertUom", UtilMisc.toMap("uomId", billingWeightUomId, "uomIdTo", DHL_WEIGHT_UOM_ID, "originalValue", billingWeight));
            ...
            while (shipmentPackageRouteSegIter.hasNext()) {
                ...
                results = dispatcher.runSync("convertUom", UtilMisc.toMap("uomId", weightUomId, "uomIdTo", DHL_WEIGHT_UOM_ID, "originalValue", packageWeight));
