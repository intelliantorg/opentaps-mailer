...
public class ShipmentServices {
    ...
    // TODO: Make this service transactional by OdbcPackageIn row so that a failure in one row doesn't roll back the whole run
    public static Map updateShipmentsFromStaging(DispatchContext dctx, Map context) {
        ...
        while (i.hasNext()) {
            ...
            try {
                ...
                // TODO: This is bad, bad, bad. The clearShipmentStaging service just wipes out the table without caring about what was just processed and
                //  what's left unprocessed. Replace with an incremental delegator remove.
