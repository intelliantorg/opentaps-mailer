...
<#assign timeZone = Static["org.ofbiz.base.util.UtilHttp"].getTimeZone(request)/>
<#assign dateFormat = Static["org.ofbiz.base.util.UtilDateTime"].getDateTimeFormat(locale)/>
<div class="screenlet">
        ...
        <#if picklistInfoList?has_content>
            <#list picklistInfoList as picklistInfo>
                ...
                <div class="tabletext">
                    ...
                    <b>date</b> ${Static["org.ofbiz.base.util.UtilDateTime"].timeStampToString(picklist.picklistDate, dateFormat, timeZone, locale)}
                            ...
                            <form method="post" action="<@ofbizUrl>updatePicklistBin</@ofbizUrl>" style="display: inline;">
                                ...
                                <select name="picklistId" class="smallSelect">
                                    <#list picklistActiveList as picklistActive>
                                        ...
                                        <option value="${picklistActive.picklistId}"<#if picklistActive.picklistId == picklist.picklistId> selected</#if>>${picklistActive.picklistId} [${uiLabelMap.CommonDate}:${Static["org.ofbiz.base.util.UtilDateTime"].timeStampToString(picklistActive.picklistDate, dateFormat, timeZone, locale)},${uiLabelMap.CommonStatus}:${picklistActiveStatusItem.description}]</option>
                                    </#list>
                                </select>
                                <input type="submit" value="${uiLabelMap.CommonUpdate}" class="smallSubmit"/>
                            </form>
