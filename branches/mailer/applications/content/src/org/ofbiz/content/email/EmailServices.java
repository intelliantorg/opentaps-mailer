...
public class EmailServices {
    ...
    public static Map sendMailFromScreen(DispatchContext dctx, Map serviceContext) {
        ...
        System.out.println("!!!!!!!!!!!!!!!!!!!!! bodyScreenUri = "+bodyScreenUri);
        ...
        if(bodyParameters.containsKey("bodyText"))
            bodyText = (String) bodyParameters.get("bodyText");
        ...
        System.out.println("----------------------------------------------EmailService.java=>Before Expand subject=> "+subject);
        subject = FlexibleStringExpander.expandString(subject, screenContext, locale);
        System.out.println("----------------------------------------------EmailService.java=>After expand subject=> "+subject);
    ...
    throws MessagingException, IOException {
        try {
            ...
            if (UtilValidate.isEmpty(commEventMap.get("content"))) {
                Debug.logWarning("No content found in the multipart email.", module);
            }
    ...
    public static Map storeIncomingEmail(DispatchContext dctx, Map context) {
        ...
        try {
            ...
            if (contentType.startsWith("text")) {
                ...
                Debug.logWarning("Unrecognized content-type: " + contentType + " the message content will not be stored.", module);
            }
