...
<head>
    ...
    <script language="javascript" src="<@ofbizContentUrl>/images/fieldlookup.js</@ofbizContentUrl>" type="text/javascript"></script>
    <script language="javascript" src="<@ofbizContentUrl>/opentaps_js/jscalendar-1.0/calendar.js</@ofbizContentUrl>" type="text/javascript"></script>
    <script language="javascript" src="<@ofbizContentUrl>/opentaps_js/jscalendar-1.0/lang/calendar-en.js</@ofbizContentUrl>" type="text/javascript"></script>
    <script language="javascript" src="<@ofbizContentUrl>/opentaps_js/jscalendar-1.0/calendar-setup.js</@ofbizContentUrl>" type="text/javascript"></script>
    ...
    <link rel="stylesheet" href="<@ofbizContentUrl>/opentaps_js/jscalendar-1.0/calendar-system.css</@ofbizContentUrl>" type="text/css"/>
