...
/**
 * Fixtures for the Catalog application.
 */
public class OpentapsCatalog extends OpentapsCommon {

    /**
     * Creates a new <code>OpentapsCatalog</code> instance.
     * @param selenium a <code>Selenium</code> value
     * @param contextManager a <code>ContextManager</code> value
     */
    public OpentapsCatalog(Selenium selenium, ContextManager contextManager) {
        super(selenium, contextManager);
        loadUiElements(CatalogElements.values());
    }
