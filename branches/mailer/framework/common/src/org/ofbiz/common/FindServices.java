...
public class FindServices {
     ...
     */
    public static ArrayList createCondition(List keys, HashMap normalizedFields, Map queryStringMap, Map origValueMap, List dateTimeFields, TimeZone timeZone, Locale locale) {
    ...
    public static Map prepareFind(DispatchContext dctx, Map context) {
        ...
        List dateTimeFields = FastList.newInstance();
        Iterator fieldsIter = keys.iterator();
        while (fieldsIter.hasNext()) {
            ModelField field = modelEntity.getField((String)fieldsIter.next());
            String fieldType = field.getType();
            if ("date-time".equals(fieldType))
                dateTimeFields.add(field.getName());
        }
        
        ArrayList tmpList = createCondition(keys, normalizedFields, queryStringMap, origValueMap, dateTimeFields, timeZone, locale);
