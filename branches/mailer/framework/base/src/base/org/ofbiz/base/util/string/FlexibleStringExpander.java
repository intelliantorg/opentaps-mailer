        ...
        public void handleVariable(String original, int start, int end) {
            ...
            if (envVal != null) {
                if (envVal instanceof java.sql.Date) {
                    DateFormat df = UtilDateTime.toDateFormat(UtilDateTime.getDateFormat(null), timeZone, null);
                    targetBuffer.append(df.format((java.util.Date) envVal));
                } else if (envVal instanceof java.sql.Time) {
                    DateFormat df = UtilDateTime.toTimeFormat(UtilDateTime.getTimeFormat(null), timeZone, null);
                    targetBuffer.append(df.format((java.util.Date) envVal));
                } else if (envVal instanceof java.sql.Timestamp) {
                    DateFormat df = UtilDateTime.toDateTimeFormat(UtilDateTime.getDateTimeFormat(null), timeZone, null);
                    targetBuffer.append(df.format((java.util.Date) envVal));
