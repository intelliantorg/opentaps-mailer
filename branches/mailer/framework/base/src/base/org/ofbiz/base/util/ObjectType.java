        ...
        if ((type.equals("List") || type.equals("java.util.List")) && obj.getClass().isArray()) {
            ...
            if ("Boolean".equals(type) || "java.lang.Boolean".equals(type)) {
                ...
                if (format == null || format.length() == 0) {
                    ...
                    df = UtilDateTime.toDateFormat(dateFormat, timeZone, null);
                } else {
                ...
                DateFormat df = null;
                Debug.logWarning("Converting timestamp from " + str, module);
                /* check if str in timstamp format */
                ...
                try {
                    ...
                    Timestamp timeStamp = new Timestamp(fieldDate.getTime());
                    Debug.logWarning("Converted timestamp from " + str + " to " + timeStamp, module);
                    return timeStamp;
                } catch (ParseException e1) {
                    throw new GeneralException("Could not convert " + str + " to " + type + ": ", e1);
                }
