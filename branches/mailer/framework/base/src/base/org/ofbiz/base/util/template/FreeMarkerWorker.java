        ...
        if (defaultOfbizConfig == null) {
            synchronized (FreeMarkerWorker.class) {
                if (defaultOfbizConfig == null) {
                    ...
                    config.setSetting("datetime_format", UtilDateTime.getDateTimeFormat(null));
                    config.setSetting("date_format", UtilDateTime.getDateFormat(null));
                    config.setSetting("time_format", UtilDateTime.getTimeFormat(null));
