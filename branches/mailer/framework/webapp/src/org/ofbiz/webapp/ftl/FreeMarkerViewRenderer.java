...
public class FreeMarkerViewRenderer extends org.jpublish.view.freemarker.FreeMarkerViewRenderer {
    ...
    public void init() throws Exception {
        ...
        fmConfig.setSetting("datetime_format", UtilDateTime.getDateTimeFormat(null));
        fmConfig.setSetting("date_format", UtilDateTime.getDateFormat(null));
        fmConfig.setSetting("time_format", UtilDateTime.getTimeFormat(null));
    }
