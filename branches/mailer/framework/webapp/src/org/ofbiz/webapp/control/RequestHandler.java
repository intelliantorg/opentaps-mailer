...
public class RequestHandler implements Serializable {
    ...
    public void doRequest(HttpServletRequest request, HttpServletResponse response, String chain,
        ...
        if (nextView != null && nextView.startsWith("request:")) {
            ...
            if (nextView != null && nextView.startsWith("url:")) {
                ...
                Set allowedParams = (Set)requestManager.getRequestMapMap(requestUri).get(ConfigXMLReader.RESPONSE_ALLOWEDPARAMS);
                Set allowedAttributes = (Set)requestManager.getRequestMapMap(requestUri).get(ConfigXMLReader.RESPONSE_ALLOWEDATTRIBUTES);
    ...
    public String makeQueryString(HttpServletRequest request, Set allowedParams, Set allowedAttributes) {
        Map paramMap = UtilHttp.getParameterMap(request);
        
        if (allowedParams != null) {
            paramMap.keySet().retainAll(allowedParams);
        }
