        ...
        while (requestMapElementIter.hasNext()) {
            ...
            while (responseElementIter.hasNext()) {
                ...
                if (allowedParams != null && allowedParams.length() > 0) {
                    ...
                    uriMap.put(RESPONSE_ALLOWEDPARAMS, allowedParamsSet);
                }
                ...
                if (allowedAttributes != null && allowedAttributes.length() > 0) {
                    ...
                    uriMap.put(RESPONSE_ALLOWEDATTRIBUTES, allowedAttributesSet);
                }
        ...
        if (Debug.verboseOn()) {
            ...
            while (i.hasNext()) {
                ...
                while (debugIter.hasNext()) {
                    ...
                    String value = (String) thisURI.get(lo).toString();
