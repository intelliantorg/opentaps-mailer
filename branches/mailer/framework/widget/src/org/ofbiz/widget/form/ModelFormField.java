        ...
        if ((Boolean.TRUE.equals(isError) && !Boolean.FALSE.equals(useRequestParameters)) || (Boolean.TRUE.equals(useRequestParameters))) {
            ...
            if (retVal != null) {
                ...
                if (retVal instanceof Double || retVal instanceof Float || retVal instanceof BigDecimal) {
                    ...
                    return UtilDateTime.timeStampToString((new Timestamp(((java.util.Date) retVal).getTime())), UtilDateTime.getDateFormat(locale), timeZone, locale);
                } else if (retVal instanceof java.sql.Time) {
                    return UtilDateTime.timeStampToString(new Timestamp(((java.util.Date) retVal).getTime()), UtilDateTime.getTimeFormat(locale), timeZone, locale);
                } else if (retVal instanceof java.sql.Timestamp) {
                    return UtilDateTime.timeStampToString((java.sql.Timestamp)retVal, UtilDateTime.getDateTimeFormat(locale), timeZone, locale);
                ...
                return UtilValidate.isEmpty(localizedDefaultValue) ? defaultValue : localizedDefaultValue;
            }
        }
    }
