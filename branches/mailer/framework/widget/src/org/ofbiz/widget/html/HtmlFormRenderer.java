...
public class HtmlFormRenderer implements FormStringRenderer {
    ...
    public void renderDateTimeField(StringBuffer buffer, Map context, DateTimeField dateTimeField) {
        ...
        if (shortDateInput) {
            size = maxlength = 10;
            if (uiLabelMap != null) {
                localizedInputTitle = UtilProperties.getMessage("CommonUiLabels", "CommonFormatLocalizedDateTime", UtilMisc.toMap("localizedFormat", dateFormat), locale);
            }
        } else if ("time".equals(dateTimeField.getType())) {
            size = maxlength = 8;
            if (uiLabelMap != null) {
                localizedInputTitle = UtilProperties.getMessage("CommonUiLabels", "CommonFormatLocalizedDateTime", UtilMisc.toMap("localizedFormat", timeFormat), locale);
            }
        } else {
            if (uiLabelMap != null) {
                localizedInputTitle = UtilProperties.getMessage("CommonUiLabels", "CommonFormatLocalizedDateTime", UtilMisc.toMap("localizedFormat", dateTimeFormat), locale);
            }
        }
        buffer.append(" title=\"");
        ...
        if (UtilValidate.isNotEmpty(value)) {
            ...
            buffer.append(" value=\"");
            buffer.append(shortDateInput ? valueParts[0] : value);
            buffer.append('"');
        }
        ...
        if (!"time".equals(dateTimeField.getType())) {
            buffer.append("<a href=\"javascript:opentaps.toggleClass(document.getElementById('");
            buffer.append(paramName);
            buffer.append("-calendar-placeholder'), 'hidden');\">");

            buffer.append("<img id=\"");
            buffer.append(paramName);
            buffer.append("-button\" src=\"");
            ...
            buffer.append(paramName);
            buffer.append("-calendar-placeholder\" style=\"border: 0px; width: auto;\" class=\"hidden\"></table>\n");
            buffer.append("<script type=\"text/javascript\">\n");
            buffer.append("  function sampleTimestamp_onDateChange(calendar) {\n");
            buffer.append("    if (calendar.dateClicked) {\n");
            buffer.append("      var y = calendar.date.getFullYear();\n");
            buffer.append("      var m = calendar.date.getMonth();\n");
            buffer.append("      var d = calendar.date.getDate();\n");
            buffer.append("      var input = document.getElementById('");
            buffer.append(paramName);
            buffer.append("');\n");
            buffer.append("      if (input) {\n");
            buffer.append("        input.value = y+'-'+((m < 9) ? (\"0\" + (1+m)) : (1+m))+'-'+((d < 10) ? (\"0\" + d) : d);\n");
            buffer.append("      }\n");
            buffer.append("      opentaps.addClass(document.getElementById('");
            buffer.append(paramName);
            buffer.append("-calendar-placeholder'), 'hidden');\n");
            buffer.append("  }};\n");
            
            buffer.append("  function currentDtFmt() {\n");
            buffer.append("    return \"");
            buffer.append(shortDateInput ? UtilDateTime.getJsDateTimeFormat(dateFormat) : UtilDateTime.getJsDateTimeFormat(dateTimeFormat));
            buffer.append("\"  \n};\n");
            ...
            buffer.append("    weekNumbers: false,\n");
            buffer.append("    showOthers: true,\n");
...
//        buffer.append("%\"");
    ...
    public void renderDateFindField(StringBuffer buffer, Map context, DateFindField dateFindField) {
        ...
        if (!"time".equals(dateFindField.getType())) {
            buffer.append("<a href=\"javascript:opentaps.toggleClass(document.getElementById('");
            buffer.append(paramName);
            buffer.append("_fld0_value-calendar-placeholder'), 'hidden');\">");

            buffer.append("<img");
            buffer.append(" id=\"");
            buffer.append(paramName);
            buffer.append("_fld0_value-button\"");
            buffer.append(" src=\"");
            this.appendContentUrl(buffer, "/images/cal.gif");
            buffer.append("\" width=\"16\" height=\"16\" border=\"0\" alt=\"");
            buffer.append(localizedIconTitle);
        ...
        buffer.append("\",\n");
        buffer.append("    ifFormat: \"");
        buffer.append("date".equals(dateFindField.getType()) ? UtilDateTime.getJsDateTimeFormat(dateFormat) : UtilDateTime.getJsDateTimeFormat(dateTimeFormat));
        buffer.append("\",\n");
        buffer.append("    button: \"");
        buffer.append(paramName);
        buffer.append("_fld0_value");
        ...
        if (!"time".equals(dateFindField.getType())) {
            buffer.append("<a href=\"javascript:opentaps.toggleClass(document.getElementById('");
            buffer.append(paramName);
            buffer.append("_fld1_value-calendar-placeholder'), 'hidden');\">");

            buffer.append("<img");
            buffer.append(" id=\"");
            buffer.append(modelFormField.getParameterName(context));
            buffer.append("_fld1_value-button\"");
            buffer.append(" src=\"");
            this.appendContentUrl(buffer, "/images/cal.gif");
            buffer.append("\" width=\"16\" height=\"16\" border=\"0\" alt=\"");
            buffer.append(localizedIconTitle);
