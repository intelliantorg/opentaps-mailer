...
public interface PurchasingRepositoryInterface extends RepositoryInterface {
    /**
     * Finds the <code>SupplierProduct</code> from this combination of parameters.  The SupplierProduct will be the one
     * with the latest availableFromDate and highest minimumOrderQuantity, but not necessarily the lowest lastPrice
