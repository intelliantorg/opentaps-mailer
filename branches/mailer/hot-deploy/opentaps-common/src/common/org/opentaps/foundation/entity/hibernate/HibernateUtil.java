...
public class HibernateUtil {
     ...
     *             if an error occurs
     */
    public static void refreshPojoByGenericValue(Entity entity, GenericValue value)
            throws GenericEntityException {
     ...
     * @throws InvocationTargetException if an error occurs
     */
    public static Object getFieldValue(Object object, String fieldName) throws NoSuchMethodException, IllegalArgumentException, IllegalAccessException, InvocationTargetException {
        String getter = "get" + Character.toUpperCase(fieldName.charAt(0)) + fieldName.substring(1);
