 ...
 */
public abstract class StatusLookupConfiguration {

    private StatusLookupConfiguration() { }

    public static final String URL_SUGGEST_ACTIVITY_STATUS = "gwtSuggestActivityStatus";

    public static final String STATUS_TYPE_CASE = "case";
    public static final String STATUS_TYPE_ACTIVITY = "activity";
