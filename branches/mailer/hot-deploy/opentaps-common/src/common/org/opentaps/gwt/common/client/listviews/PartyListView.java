...
public abstract class PartyListView extends EntityListView {
    ...
    protected void init(String entityFindUrl, String entityViewUrl, String partyIdLabel, String[] nameColumns) {
       ...
       // makeColumn(UtilUi.MSG.attnName(), new StringFieldDef(PartyLookupConfiguration.OUT_ATTENTION_NAME));
        ...
        makeColumn("Created By", new StringFieldDef(PartyLookupConfiguration.INOUT_CREATED_BY_USER_LOGIN_DESC));
//        makeColumn("Assigned Team", new StringFieldDef(PartyLookupConfiguration.INOUT_ASSIGNED_TEAM_DESC));
        makeColumn("Assigned To", new StringFieldDef(PartyLookupConfiguration.INOUT_ASSIGNED_TO_DESC));
        ...
        makeColumn(UtilUi.MSG.country(), new StringFieldDef(PartyLookupConfiguration.INOUT_COUNTRY_NAME));
        makeColumn(UtilUi.MSG.stateOrProvince(), new StringFieldDef(PartyLookupConfiguration.INOUT_STATE_NAME));
      ...
      //  makeColumn(UtilUi.MSG.postalCodeExt(), new StringFieldDef(PartyLookupConfiguration.OUT_POSTAL_CODE_EXT));
        ...
        makeColumn(UtilUi.MSG.emailAddress(), new StringFieldDef(PartyLookupConfiguration.INOUT_EMAIL));
        
        configure(entityFindUrl, PartyLookupConfiguration.INOUT_PARTY_ID, SortDir.ASC);

        // by default, hide non essential columns
        setColumnHidden(PartyLookupConfiguration.OUT_NUMBER_OF_ACCOUNTS_FOR_CONTACT, true);
//        setColumnHidden(PartyLookupConfiguration.INOUT_ASSIGNED_TEAM_DESC, true);
        //setColumnHidden(PartyLookupConfiguration.INOUT_ASSIGNED_TO_DESC, true);
    ...
    public void filterByStateProvince(String stateProvinceGeoId) {
        setFilter(PartyLookupConfiguration.INOUT_STATE1, stateProvinceGeoId);
    }
