 ...
 */
public class CasePriorityAutocomplete extends EntityAutocomplete {
    ...
    public CasePriorityAutocomplete(String fieldLabel, String name, int fieldWidth) {
        super(fieldLabel, name, fieldWidth, CaseLookupConfiguration.URL_SUGGEST_CASE_PRIORITY, CaseLookupConfiguration.INOUT_DESCRIPTION);
    }
}
