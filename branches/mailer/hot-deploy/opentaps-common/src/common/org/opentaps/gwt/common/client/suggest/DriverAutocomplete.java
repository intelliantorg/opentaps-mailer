 ...
 */
public class DriverAutocomplete extends EntityAutocomplete {

	public DriverAutocomplete(String fieldLabel, String name, int fieldWidth) {
   	super(fieldLabel, name, fieldWidth, ResourceLookupConfiguration.URL_SUGGEST_RES_DRIVERS, ResourceLookupConfiguration.INOUT_PARTY_ID);
   }
     ...
     */
    public DriverAutocomplete(String fieldLabel, String name, DateField estimatedStartDateField, TimeField estimatedStartTimeField, TextField duration, int fieldWidth) {
