...
<form action="" name="findCampaignForm" method="post">
	...
	<div>
		<@inputSubmit title=uiLabelMap.ButtonPrint onClick="return validateThisForm('print')" />
		<@inputSubmit title=uiLabelMap.ButtonEmail onClick="return validateThisForm('email')" />
		<span id="message" class="tabletext" style="color:red"></span>
	</div>
</form>