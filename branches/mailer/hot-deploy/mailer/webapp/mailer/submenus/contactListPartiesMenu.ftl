...
<div class="subSectionHeader">
  ...
  <div class="subMenuBar"><a class="subMenuButton" href="#?contactListId=${contactList.contactListId}" >Remove Selected</a><a class="subMenuButton" href="importContactListForm?contactListId=${contactList.contactListId}" >Import List</a>${addLink?if_exists}${addDomestic?if_exists}${addForeign?if_exists}
  	</div>
</div>
